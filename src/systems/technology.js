...
export class TechnologySystem{
 constructor(sim=null,data=null){this.sim=sim;this.discoveries=data?.discoveries||[];this.crossGroupTransfers=data?.crossGroupTransfers||0}
 ...
 serialize(){return{discoveries:this.discoveries,crossGroupTransfers:this.crossGroupTransfers}}
