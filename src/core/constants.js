...
export const RESOURCE={LOG:0,STONE:1,IRON:2,GRAIN:3,WATER:4,LEATHER:5,BERRY:6,MEAT:7,FISH:8,PRESERVED:9,WOOL:10,CLAY:11,SEED:12,EGG:13,MILK:14,COUNT:15,NAMES:['toras','pedra','ferro','grãos','água','couro','frutas','carne','peixe','conserva','lã','argila','sementes','ovos','leite']};
...
export const TILE_TYPE={GRASS:0,WATER:1,FOREST:2,STONE:3,MOUNTAIN:4,MARSH:5,BEACH:6,TRAIL:7,ROAD:8,DUNGEON:9,BUILDING:10};
export const BIOME={FIELD:0,OPEN_FOREST:1,DENSE_FOREST:2,ROCK:3,MOUNTAIN:4,MARSH:5,BEACH:6,WATER:7,NAMES:['campo','bosque','floresta','rochedo','montanha','pântano','praia','água']};
