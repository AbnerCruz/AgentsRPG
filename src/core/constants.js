...
export const ACTIVE_SKILLS=[0,1,2,6,7,10,13];
...
export const BUILDING={SHELTER:0,FARM:1,FORGE:2,STORAGE:3,WELL:4,NAMES:['abrigo','fazenda','forja','armazém','poço']};
export const PROF=['sem profissão','fazendeiro','lenhador','minerador','ferreiro','guerreiro'];
export const ACTION={IDLE:'observar',EAT:'comer',DRINK:'beber',SLEEP:'dormir',WARM:'buscar abrigo',FORAGE:'buscar comida',WATER:'buscar água',WOOD:'cortar madeira',STONE:'coletar pedra',IRON:'minerar ferro',FARM:'cultivar',SOCIAL:'conversar',BUILD:'construir',EXPLORE:'explorar',DUNGEON:'descer à dungeon',FIGHT:'lutar',FLEE:'fugir',DEPOSIT:'depositar recursos',CRAFT:'forjar equipamento'};
